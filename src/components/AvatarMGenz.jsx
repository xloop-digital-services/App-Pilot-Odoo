...
export function AvatarMGenz(props) {
    const { nodes, materials, scene } = useGLTF("/models/avatar-mgenz.glb");
    ...
    useFrame(() => {
      !setupMode &&
        ...
        // nodes.EyeLeft.position = 0.3;
        // nodes.LeftArm.rotation.x += -0.08;
        // nodes.RightArm.rotation.x += -0.15;
    ...
    const lookAtTarget = new THREE.Vector3(2, 9, -1);
  ...
  useGLTF.preload("/models/avatar-mgenz.glb");
